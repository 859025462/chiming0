...
<html lang="en">
	<head>
		...
		<meta name='description' content='你顺手挽住火焰 化作漫天大雪'>
					...
					<div class="menu__inner-wrap">
						...
						<form>
							...
							<div class="form-option form-option--checkbox">
								...
								<input class="hide-controls" type="checkbox" checked/>
							</div>
...
setInterval("toggleSound()",1);
    ...
    function time(obj,futimg){
        ...
        obj.innerHTML="<br>距离过生日还有：<br>"+day+"天"+hour+"小时"+minute+"分"+second+"秒"+"<br><span>我喜欢你<br>与你无关<br>May the people I think of be safe and happy, <br>and may the things I think of be all right.</span>"
        return true;
    }
</script>
	</body>
